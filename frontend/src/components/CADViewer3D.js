...
const CADViewer3D = ({ design }) => {
  ...
  useEffect(() => {
    ...
    if (type === 'cylinder') {
      ...
      mesh.scale.set(4, 4, 4); // Larger scale for better visibility
    } else if (type === 'gear') {
      // Create gear shape
      ...
      mesh.scale.set(6, 6, 6); // Much larger scale for clear teeth visibility
      ...
      mesh.scale.set(3, 3, 3); // Much larger scale for boxes
    }
